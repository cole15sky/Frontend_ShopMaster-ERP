      ...
      >
        ...
        <div className="hidden lg:flex flex-col justify-between p-12 bg-gradient-to-br from-indigo-600/20 to-transparent border-r border-white/10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-white tracking-tight uppercase">ShopApp <span className="text-indigo-400">OS</span></span>
          </div>
          ...
          <div>
            ...
            >
              <h1 className="text-5xl font-bold text-white leading-[1.1] mb-6">
                Next-Gen <br /> 
                <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Retail Intelligence</span>
              </h1>
